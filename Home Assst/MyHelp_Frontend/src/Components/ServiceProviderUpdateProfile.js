...
class ServiceProviderUpdateProfile extends Component {
    ...
    constructor(props){
        super(props);
        this.state={
        id:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider._id,
        Name:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.Name,
        MobileNo:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.MobileNo,
        Gender:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.Gender,
        City:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.City,
        Email:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.email,
        Price:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.Price,
        Occupation:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.Occupation,
        Description:(typeof this.props.serviceProvider === 'undefined') ? '' : this.props.serviceProvider.Description,
        touched: {
            Name:false,
            MobileNo:false,
            City:false,
                    ...
                    <Row className="container-fluid" form>
                        ...
                        <Col className="container-fluid" md={6}>
                            ...
                            <Label htmlfor="Occupation">Occupation</Label>
                                    <Input required type="select" name="Occupation" id="Occupation" value={this.state.Occupation} className="form-control"
                                        onChange={this.handleInputChange}>
                                        <option defaultValue>Select</option>
